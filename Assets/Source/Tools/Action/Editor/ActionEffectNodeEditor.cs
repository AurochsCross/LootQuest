...
namespace Tools.Action.Editor {
    [CustomNodeEditor(typeof(ActionEffect))]
    public class ActionEffectEditor : NodeEditor {
        public override void OnBodyGUI() {
            ActionEffect node = target as ActionEffect;
        ...
        private void DrawEffectArray(ActionEffect node) {
        ...
        private void DrawWindupEffectArray(ActionEffect node) {
                // TODO: Implement new effect system
